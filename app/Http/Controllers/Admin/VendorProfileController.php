...
class VendorProfileController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            $query = VendorProfile::with(['franchisee', 'organization_state', 'organization_district', 'organization_city', 'representative_state', 'representative_district', 'representative_city'])->select(sprintf('%s.*', (new VendorProfile)->table));
            ...
            $table->editColumn('payment_method', function ($row) {
                return $row->payment_method ? VendorProfile::PAYMENT_METHOD_RADIO[$row->payment_method] : '';
            });
    ...
    public function create()
    {
        ...
        $franchisees = Vendor::all()->pluck('name', 'id')->prepend(trans('global.pleaseSelect'), '');
    ...
    public function edit(VendorProfile $franchiseeProfile)
    {
    ...
    {
        VendorProfile::whereIn('id', request('ids'))->delete();
    ...
    {
        $franchisee = Vendor::find($request->franchiseeId);
