...
class HomeController
{
    ...
    {
        $settings1 = [
            'chart_title'           => trans('global.total') . ' ' . trans('cruds.product.title'),
        ...
        $settings2 = [
            'chart_title'           => trans('global.total') . ' ' . trans('cruds.user.title'),
            'chart_type'            => 'number_block',
            'report_type'           => 'group_by_date',
        ...
        $settings4 = [
            'chart_title'           => trans('global.total') . ' ' . trans('cruds.order.title'),
            'chart_type'            => 'number_block',
            'report_type'           => 'group_by_date',
        ...
        $settings6 = [
            'chart_title'           => trans('global.total') . ' ' . trans('cruds.helpCenter.title'),
            'chart_type'            => 'number_block',
            'report_type'           => 'group_by_date',
        ...
        $settings7 = [
            'chart_title'           => trans('global.total') . ' ' . trans('global.revenue'),
            'chart_type'            => 'number_block',
            'report_type'           => 'group_by_date',
        ...
        $settings8 = [
            'chart_title'           => trans('global.total') . ' ' . trans('cruds.vendor.title'),
            'chart_type'            => 'number_block',
            'report_type'           => 'group_by_date',
        ...
        $settings9 = [
            'chart_title'           => trans('cruds.transaction.title') . ' ' . trans('global.report'),
            'chart_type'            => 'line',
            'report_type'           => 'group_by_date',
            'model'                 => 'App\Models\Transaction',
            'group_by_field'        => 'created_at',
        ...
        $settings10 = [
            'chart_title'           => trans('cruds.order.title') . ' ' . trans('global.report'),
            'chart_type'            => 'line',
            'report_type'           => 'group_by_date',
            'model'                 => 'App\Models\Order',
            'group_by_field'        => 'created_at',
        ...
        $settings11 = [
            'chart_title'           => trans('global.recent') . ' ' . trans('cruds.order.title'),
