...
// \App\Http\Middleware\TrustHosts::class,
    ...
    protected $routeMiddleware = [
        ...
        'franchisee' => \App\Http\Middleware\RedirectIfNotVendor::class,
        'franchisee.guest' => \App\Http\Middleware\RedirectIfVendor::class,
        ...
        'check_if_franchisee_has_active_membership_plan' => \App\Http\Middleware\CheckIfVendorHasActiveMembershipPlan::class,
    ];
