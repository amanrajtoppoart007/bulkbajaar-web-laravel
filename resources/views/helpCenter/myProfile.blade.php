...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            ...
            <a href="{{ route('helpCenter.show.upload.documents.form') }}" class="pull-right">{{ trans('cruds.uploadDocuments.title') }}</a>
        </div>

        <div class="card-body">
            <form method="post" action="{{ route('helpCenter.update.profile') }}" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            <label class="required" for="name">{{ trans('cruds.helpCenter.fields.name') }}</label>
                            <input class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" type="text" name="name" id="name" value="{{ old('name', $helpCenter->name) }}">
                            @if($errors->has('name'))
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <input class="form-control {{ $errors->has('email') ? 'is-invalid' : '' }}" type="email" name="email" id="email" value="{{ old('email', $helpCenter->email) }}" required>
                            @if($errors->has('email'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('email') }}
                                </div>
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <input class="form-control {{ $errors->has('mobile') ? 'is-invalid' : '' }}" type="text" name="mobile" id="mobile" value="{{ old('mobile', $helpCenter->mobile) }}" required>
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            <label class="required" for="secondary_contact">{{ trans('cruds.helpCenterProfile.fields.secondary_contact') }}</label>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control {{ $errors->has('role') ? 'is-invalid' : '' }}" name="role" id="role">
                                ...
                                @foreach(App\Models\HelpCenter::ROLE_SELECT as $key => $label)
                                    <option value="{{ $key }}" {{ old('role', $helpCenter->role) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                                @endforeach
                            </select>
                            @if($errors->has('role'))
                                <div class="invalid-feedback">
                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            <label for="organization_name">{{ trans('cruds.helpCenterProfile.fields.organization_name') }}</label>
                            ...
                            @endif
                            <span class="help-block">{{ trans('cruds.helpCenterProfile.fields.organization_name_helper') }}</span>
                        </div>
                        <div class="form-group">
                            <label for="organization_address">{{ trans('cruds.helpCenterProfile.fields.organization_address') }}</label>
                            ...
                            @endif
                            <span class="help-block">{{ trans('cruds.helpCenterProfile.fields.organization_address_helper') }}</span>
                        </div>
                        <div class="form-group">
                            ...
                            @endif
                            <span class="help-block">{{ trans('cruds.helpCenterProfile.fields.organization_address_line_two_helper') }}</span>
                        </div>
                        <div class="form-group">
                            <label for="organization_street">{{ trans('cruds.helpCenterProfile.fields.organization_street') }}</label>
                        ...
                        <div class="form-group">
                            <label for="organization_state_id">{{ trans('cruds.helpCenterProfile.fields.organization_state') }}</label>
                            ...
                            @endif
                            <span class="help-block">{{ trans('cruds.helpCenterProfile.fields.organization_state_helper') }}</span>
                        </div>
                        <div class="form-group">
                            <label for="organization_district_id">{{ trans('cruds.helpCenterProfile.fields.organization_district') }}</label>
                            ...
                            @endif
                            <span class="help-block">{{ trans('cruds.helpCenterProfile.fields.organization_city_helper') }}</span>
                        </div>
                        <div class="form-group">
                            <label for="organization_city_id">{{ trans('cruds.helpCenterProfile.fields.organization_city') }}</label>
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            <label class="required" for="representative_name">{{ trans('cruds.helpCenterProfile.fields.representative_name') }}</label>
                            ...
                            @endif
                            <span class="help-block">{{ trans('cruds.helpCenterProfile.fields.representative_name_helper') }}</span>
                        </div>
                        <div class="form-group">
                            <label for="representative_designation">{{ trans('cruds.helpCenterProfile.fields.representative_designation') }}</label>
                            ...
                            @endif
                            <span class="help-block">{{ trans('cruds.helpCenterProfile.fields.representative_designation_helper') }}</span>
                        </div>
                        <div class="form-group">
                            <label class="required" for="representative_address">{{ trans('cruds.helpCenterProfile.fields.representative_address') }}</label>
                            ...
                            @endif
                            <span class="help-block">{{ trans('cruds.helpCenterProfile.fields.representative_address_helper') }}</span>
                        </div>
                        <div class="form-group">
                            <label for="representative_address_line_two">{{ trans('cruds.helpCenterProfile.fields.representative_address_line_two') }}</label>
                        ...
                        @if($errors->has('representative_address_line_two'))
                            ...
                            @endif
                            <span class="help-block">{{ trans('cruds.helpCenterProfile.fields.representative_address_line_two_helper') }}</span>
                        </div>
                        <div class="form-group">
                            <label class="required" for="representative_street">{{ trans('cruds.helpCenterProfile.fields.representative_street') }}</label>
                            ...
                            @endif
                            <span class="help-block">{{ trans('cruds.helpCenterProfile.fields.representative_street_helper') }}</span>
                        </div>
                        <div class="form-group">
                            <label class="required" for="representative_state_id">{{ trans('cruds.helpCenterProfile.fields.representative_state') }}</label>
                            ...
                            @endif
                            <span class="help-block">{{ trans('cruds.helpCenterProfile.fields.representative_state_helper') }}</span>
                        </div>
                        <div class="form-group">
                            <label class="required" for="representative_district_id">{{ trans('cruds.helpCenterProfile.fields.representative_district') }}</label>
                            ...
                            @endif
                            <span class="help-block">{{ trans('cruds.helpCenterProfile.fields.representative_district_helper') }}</span>
                        </div>
                        <div class="form-group">
                            <label class="required" for="representative_city_id">{{ trans('cruds.helpCenterProfile.fields.representative_city') }}</label>
                            ...
                            @endif
                            <span class="help-block">{{ trans('cruds.helpCenterProfile.fields.representative_city_helper') }}</span>
                        </div>
                        <div class="form-group mb-3">
