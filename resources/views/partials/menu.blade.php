    ...
    <ul class="c-sidebar-nav mt-2">
        <li class="c-sidebar-nav-item">
            <a href="{{ route("admin.home") }}" class="c-sidebar-nav-link">
                ...
                <svg class="c-sidebar-nav-icon" enable-background="new 0 0 64 64" height="30" viewBox="0 0 64 64"
                     width="30"
                        ...
                        <li class="d-none c-sidebar-nav-item">
                            <a href="{{ route("admin.user-profiles.index") }}"
                               class="c-sidebar-nav-link {{ request()->is("admin/user-profiles") || request()->is("admin/user-profiles/*") ? "c-active" : "" }}">
                                ...
                                <svg height="30" width="30" class="c-sidebar-nav-icon" viewBox="-42 0 512 512.001"
                                     xmlns="http://www.w3.org/2000/svg">
                                    <path
            ...
            <ul class="c-sidebar-nav-dropdown-items">
                ...
                <li class="c-sidebar-nav-item">
                    <a href="{{ route("admin.bills.index") }}"
                       class="c-sidebar-nav-link {{ request()->is("admin/bills") || request()->is("admin/bills/*") ? "c-active" : "" }}">
                        <svg class="c-sidebar-nav-icon" enable-background="new 0 0 480 480" height="30"
                ...
                <li class="c-sidebar-nav-item">
                    <a href="{{ route("admin.master-stocks.index") }}"
                       class="c-sidebar-nav-link {{ request()->is("admin/master-stocks") || request()->is("admin/master-stocks/*") ? "c-active" : "" }}">
                        <svg xmlns="http://www.w3.org/2000/svg" class="c-sidebar-nav-icon" viewBox="0 0 64 64"
                             width="30" height="30">
                            <path
...
<g>
    <g>
        ...
        @can('organisation_access')
            <li class="c-sidebar-nav-dropdown {{ request()->is("admin/franchisees*") ? "c-show" : "" }} {{ request()->is("admin/franchisee-profiles*") ? "c-show" : "" }} {{ request()->is("admin/help-centers*") ? "c-show" : "" }} {{ request()->is("admin/help-center-profiles*") ? "c-show" : "" }} {{ request()->is("admin/help-center-memberships*") ? "c-show" : "" }} {{ request()->is("admin/franchisee-memberships*") ? "c-show" : "" }}">
                <a class="c-sidebar-nav-dropdown-toggle" href="#">
                    ...
                    @can('franchisee_profile_access')
                        ...
                        <li class="c-sidebar-nav-item">
                            <a href="{{ route("admin.franchisee-memberships.index") }}"
                               class="c-sidebar-nav-link {{ request()->is("admin/franchisee-memberships") || request()->is("admin/franchisee-memberships/*") ? "c-active" : "" }}">
                                ...
                                {{ trans('cruds.franchisee.title') }} {{ trans('cruds.membership.title') }}
                            </a>
                        </li>
                    @endcan
                    ...
                    @can('help_center_profile_access')
                        ...
                        <li class="c-sidebar-nav-item">
                            <a href="{{ route("admin.help-center-memberships.index") }}"
                               class="c-sidebar-nav-link {{ request()->is("admin/help-center-memberships") || request()->is("admin/help-center-memberships/*") ? "c-active" : "" }}">
                                ...
                                {{ trans('cruds.helpCenter.title') }} {{ trans('cruds.membership.title') }}
                            </a>
                        </li>
                    @endcan
                </ul>
