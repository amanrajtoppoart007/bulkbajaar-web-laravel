    ...
    <div class="card">
        <div class="card-header">
            ...
            <div class="float-right">
                ...
                @endif
                <a class="btn btn-default" href="{{ route('logistics.assigned-orders.index') }}">
    ...
    <script>
        $(function () {
            ...
            $('#statusForm').submit(function (event) {
                ...
                $.post("{{ route("logistics.assigned-orders.update.status") }}", $(this).serialize(), result => {
            ...
            $('#confirm-button').click(() => {
                if (confirm('Are you sure want to confirm?')){
                    $.post("{{ route("logistics.assigned-orders.confirm") }}", {orderId}, result => {
                        alert(result.message);
                        if (result.status) {
                            location.reload()
                        }
