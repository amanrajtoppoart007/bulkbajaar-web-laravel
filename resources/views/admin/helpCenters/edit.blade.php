...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.helpCenter.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.help-centers.update", [$helpCenter->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="row">
                <div class="col-6">
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" type="text" name="name" id="name" value="{{ old('name', $helpCenter->name) }}" required>
                        @if($errors->has('name'))
                ...
                <div class="col-6">
                    <div class="form-group">
                        <label for="password">{{ trans('cruds.helpCenter.fields.password') }}</label>
