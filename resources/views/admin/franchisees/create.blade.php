                    ...
                    <div class="col-6">
                        <div class="form-group">
                            <label class="required"
                                   for="password">{{ trans('cruds.franchisee.fields.password') }}</label>
                ...
                let pincodes = '';
                    $.each(data, (i,e) => {
                        pincodes += `<div class="col-6">`+
                            ...
                            `<input class="form-check-input pincode" type="checkbox" id="pincode-${e.id}" value="${e.id}">`+
                            ...
                            $.each(e.areas, (ai, ae) => {
                                areas += `<div class="col-4">` +
                                    `<div class="form-group">` +
                                    `<div class="form-check">` +
                                    `<input class="form-check-input" type="checkbox" name="area[${e.id}][]" id="area-${ae.id}" value="${ae.id}" disabled>` +
