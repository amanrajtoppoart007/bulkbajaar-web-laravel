...
@can('franchisee_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('admin.franchisees.create') }}">
                {{ trans('global.add') }} {{ trans('cruds.franchisee.title_singular') }}
            </a>
            <button class="btn btn-warning" data-toggle="modal" data-target="#csvImportModal">
                {{ trans('global.app_csvImport') }}
            </button>
            @include('csvImport.modal', ['model' => 'Franchisee', 'route' => 'admin.franchisees.parseCsvImport'])
        </div>
    </div>
@endcan
<div class="card">
...
@can('franchisee_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('admin.franchisees.massDestroy') }}",
...
@endcan
  ...
  let dtOverrideGlobals = {
    ...
    retrieve: true,
    aaSorting: [],
    ajax: "{{ route('admin.franchisees.index') }}",
    columns: [
