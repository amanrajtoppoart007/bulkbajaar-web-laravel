...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-addressOrders">
                <thead>
                    <tr>
                        <th width="10">
                    ...
                    @foreach($orders as $key => $order)
                        <tr data-entry-id="{{ $order->id }}">
                            ...
                            <td>
                                ...
                                @can('order_edit')
                                    <a class="btn btn-xs btn-info d-none" href="{{ route('admin.orders.edit', $order->id) }}">
                                        {{ trans('global.edit') }}
                                    </a>
                                @endcan
...
@endcan
  ...
  let table = $('.datatable-addressOrders:not(.ajaxTable)').DataTable({ buttons: dtButtons })
