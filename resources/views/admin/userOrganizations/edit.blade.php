...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.userOrganization.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.user-organizations.update", [$userOrganization->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('user') ? 'is-invalid' : '' }}" name="user_id" id="user_id">
                    @foreach($users as $id => $user)
                        <option value="{{ $id }}" {{ (old('user_id') ? old('user_id') : $userOrganization->user->id ?? '') == $id ? 'selected' : '' }}>{{ $user }}</option>
                    @endforeach
                </select>
                @if($errors->has('user'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('gst_number') ? 'is-invalid' : '' }}" type="text" name="gst_number" id="gst_number" value="{{ old('gst_number', $userOrganization->gst_number) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('organization_name') ? 'is-invalid' : '' }}" type="text" name="organization_name" id="organization_name" value="{{ old('organization_name', $userOrganization->organization_name) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('representative_name') ? 'is-invalid' : '' }}" type="text" name="representative_name" id="representative_name" value="{{ old('representative_name', $userOrganization->representative_name) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('representative_designation') ? 'is-invalid' : '' }}" type="text" name="representative_designation" id="representative_designation" value="{{ old('representative_designation', $userOrganization->representative_designation) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('email') ? 'is-invalid' : '' }}" type="email" name="email" id="email" value="{{ old('email', $userOrganization->email) }}">
                @if($errors->has('email'))
                    <div class="invalid-feedback">
                        {{ $errors->first('email') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('primary_contact') ? 'is-invalid' : '' }}" type="text" name="primary_contact" id="primary_contact" value="{{ old('primary_contact', $userOrganization->primary_contact) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('secondary_contact') ? 'is-invalid' : '' }}" type="text" name="secondary_contact" id="secondary_contact" value="{{ old('secondary_contact', $userOrganization->secondary_contact) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('work_area') ? 'is-invalid' : '' }}" type="text" name="work_area" id="work_area" value="{{ old('work_area', $userOrganization->work_area) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('amount_deposited_method') ? 'is-invalid' : '' }}" type="text" name="amount_deposited_method" id="amount_deposited_method" value="{{ old('amount_deposited_method', $userOrganization->amount_deposited_method) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('amount_deposited') ? 'is-invalid' : '' }}" type="text" name="amount_deposited" id="amount_deposited" value="{{ old('amount_deposited', $userOrganization->amount_deposited) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('organization_address') ? 'is-invalid' : '' }}" name="organization_address" id="organization_address">{{ old('organization_address', $userOrganization->organization_address) }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('organization_street') ? 'is-invalid' : '' }}" type="text" name="organization_street" id="organization_street" value="{{ old('organization_street', $userOrganization->organization_street) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('organization_address_line_two') ? 'is-invalid' : '' }}" name="organization_address_line_two" id="organization_address_line_two">{{ old('organization_address_line_two', $userOrganization->organization_address_line_two) }}</textarea>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('organization_district') ? 'is-invalid' : '' }}" name="organization_district_id" id="organization_district_id">
                    @foreach($organization_districts as $id => $organization_district)
                        <option value="{{ $id }}" {{ (old('organization_district_id') ? old('organization_district_id') : $userOrganization->organization_district->id ?? '') == $id ? 'selected' : '' }}>{{ $organization_district }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('organization_city') ? 'is-invalid' : '' }}" name="organization_city_id" id="organization_city_id">
                    @foreach($organization_cities as $id => $organization_city)
                        <option value="{{ $id }}" {{ (old('organization_city_id') ? old('organization_city_id') : $userOrganization->organization_city->id ?? '') == $id ? 'selected' : '' }}>{{ $organization_city }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('organization_state') ? 'is-invalid' : '' }}" name="organization_state_id" id="organization_state_id">
                    @foreach($organization_states as $id => $organization_state)
                        <option value="{{ $id }}" {{ (old('organization_state_id') ? old('organization_state_id') : $userOrganization->organization_state->id ?? '') == $id ? 'selected' : '' }}>{{ $organization_state }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('organization_pincode') ? 'is-invalid' : '' }}" type="number" name="organization_pincode" id="organization_pincode" value="{{ old('organization_pincode', $userOrganization->organization_pincode) }}" step="1">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('representative_address') ? 'is-invalid' : '' }}" name="representative_address" id="representative_address">{{ old('representative_address', $userOrganization->representative_address) }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('representative_street') ? 'is-invalid' : '' }}" type="text" name="representative_street" id="representative_street" value="{{ old('representative_street', $userOrganization->representative_street) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('representative_address_line_two') ? 'is-invalid' : '' }}" name="representative_address_line_two" id="representative_address_line_two">{{ old('representative_address_line_two', $userOrganization->representative_address_line_two) }}</textarea>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('representative_district') ? 'is-invalid' : '' }}" name="representative_district_id" id="representative_district_id">
                    @foreach($representative_districts as $id => $representative_district)
                        <option value="{{ $id }}" {{ (old('representative_district_id') ? old('representative_district_id') : $userOrganization->representative_district->id ?? '') == $id ? 'selected' : '' }}>{{ $representative_district }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('representative_city') ? 'is-invalid' : '' }}" name="representative_city_id" id="representative_city_id">
                    @foreach($representative_cities as $id => $representative_city)
                        <option value="{{ $id }}" {{ (old('representative_city_id') ? old('representative_city_id') : $userOrganization->representative_city->id ?? '') == $id ? 'selected' : '' }}>{{ $representative_city }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('representative_state') ? 'is-invalid' : '' }}" name="representative_state_id" id="representative_state_id">
                    @foreach($representative_states as $id => $representative_state)
                        <option value="{{ $id }}" {{ (old('representative_state_id') ? old('representative_state_id') : $userOrganization->representative_state->id ?? '') == $id ? 'selected' : '' }}>{{ $representative_state }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('representative_pincode') ? 'is-invalid' : '' }}" type="number" name="representative_pincode" id="representative_pincode" value="{{ old('representative_pincode', $userOrganization->representative_pincode) }}" step="1">
