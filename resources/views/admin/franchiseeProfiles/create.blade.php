...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            {{ trans('global.create') }} {{ trans('cruds.franchiseeProfile.title_singular') }}
        </div>

        <div class="card-body">
            <form method="POST" action="{{ route("admin.franchisee-profiles.store") }}" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <label id="profile_already_exists" class="d-none text-danger">{{ trans('global.profile_already_exists') }}</label>
                            <select class="form-control select2 {{ $errors->has('franchisee') ? 'is-invalid' : '' }}"
                                    name="franchisee_id" id="franchisee_id" required>
                                @foreach($franchisees as $id => $franchisee)
                                    <option
                                        value="{{ $id }}" {{ old('franchisee_id') == $id ? 'selected' : '' }}>{{ $franchisee }}</option>
                                @endforeach
                            </select>
                            @if($errors->has('franchisee_id'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('franchisee_id') }}
                                </div>
                            @endif
                            <span
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            <label class="required" for="email">{{ trans('cruds.franchiseeProfile.fields.email') }}</label>
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <input class="form-control {{ $errors->has('work_area') ? 'is-invalid' : '' }}" type="text"
                                   name="work_area" id="work_area" value="{{ old('work_area', '') }}">
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <textarea
                                        ...
                                        id="organization_address">{{ old('organization_address') }}</textarea>
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <input
                                        ...
                                        type="text" name="organization_address_line_two" id="organization_address_line_two"
                                        value="{{ old('organization_address_line_two', '') }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <select
                                        ...
                                        @foreach($pincodes as $id => $pincode)
                                            <option
                                                value="{{ $id }}" {{ old('organization_pincode_id') == $id ? 'selected' : '' }}>{{ $pincode }}</option>
                                        @endforeach
                                    </select>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <input
                                        ...
                                        value="{{ old('representative_designation', '') }}">
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <textarea
                                        ...
                                        id="representative_address" required>{{ old('representative_address') }}</textarea>
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <input
                                        ...
                                        id="representative_address_line_two" value="{{ old('representative_address_line_two') }}">
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <input class="form-control {{ $errors->has('representative_street') ? 'is-invalid' : '' }}"
                                           type="text" name="representative_street" id="representative_street"
                                           value="{{ old('representative_street', '') }}" required>
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <select
                                        ...
                                        @foreach($pincodes as $id => $pincode)
                                            <option
                                                value="{{ $id }}" {{ old('representative_pincode_id') == $id ? 'selected' : '' }}>{{ $pincode }}</option>
                                        @endforeach
                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            <label for="aadhaar_card" class="required">{{ trans('cruds.franchiseeProfile.fields.aadhaar_card') }}</label>
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            <label for="pan_card" class="required">{{ trans('cruds.franchiseeProfile.fields.pan_card') }}</label>
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            <label class="required" for="address_proof">{{ trans('cruds.franchiseeProfile.fields.address_proof') }}</label>
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <input
                                        ...
                                        value="{{ old('registration_fees', '') }}" step="0.01">
                                    ...
                                    @foreach(App\Models\FranchiseeProfile::PAYMENT_METHOD_RADIO as $key => $label)
                                        <div
                                            ...
                                            <input class="form-check-input" type="radio" id="payment_method_{{ $key }}"
                                                   ...
                                                   {{ old('payment_method', '') === (string) $key ? 'checked' : '' }}>
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            <label
                                   for="signature">{{ trans('cruds.franchiseeProfile.fields.signature') }}</label>
                ...
                <div class="form-group">
                    <button class="btn btn-danger" id="submit-button" type="submit">
                        {{ trans('global.save') }}
                    </button>
                </div>
            </form>
...
@section('scripts')
    <script>
        $(document).ready(function () {
            ...
            $('#franchisee_id').change(function (){
                let franchiseeId = $(this).val();
                $.post("{{ route('admin.franchisee-profiles.check-profile') }}", {franchiseeId}, result => {
                    if(result.status){
                        $('#profile_already_exists').removeClass('d-none');
                        $('#submit-button').prop('disabled', true);
                    }else{
                        $('#profile_already_exists').addClass('d-none');
