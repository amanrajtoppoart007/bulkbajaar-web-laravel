...
<div class="card">
    ...
    <div class="card-body">
        <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-UserProfile">
            <thead>
                <tr>
                    <th width="10">
...
@endcan
  ...
  let table = $('.datatable-UserProfile').DataTable(dtOverrideGlobals);
