...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-blockPincodes">
                <thead>
                    <tr>
                        <th width="10">
                ...
                <tbody>
                    @foreach($pincodes as $key => $pincode)
                        <tr data-entry-id="{{ $pincode->id }}">
                            ...
                            <td>
                                <span style="display:none">{{ $pincode->status ?? '' }}</span>
...
@endcan
  ...
  let table = $('.datatable-blockPincodes:not(.ajaxTable)').DataTable({ buttons: dtButtons })
