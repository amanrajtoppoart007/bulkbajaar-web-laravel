...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            {{ trans('global.create') }} {{ trans('cruds.helpCenterProfile.title_singular') }}
        </div>

        <div class="card-body">
            <form method="POST" action="{{ route("admin.help-center-profiles.store") }}" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <select class="form-control select2 {{ $errors->has('help_center') ? 'is-invalid' : '' }}"
                                ...
                                @foreach($help_centers as $id => $help_center)
                                    <option
                                        value="{{ $id }}" {{ old('help_center_id') == $id ? 'selected' : '' }}>{{ $help_center }}</option>
                                @endforeach
                            </select>
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <input class="form-control {{ $errors->has('secondary_contact') ? 'is-invalid' : '' }}"
                                   ...
                                   value="{{ old('secondary_contact', '') }}" required>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <textarea
                                        ...
                                        required>{{ old('representative_address') }}</textarea>
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    @endif
                                    <span
                                        class="help-block">{{ trans('cruds.helpCenterProfile.fields.representative_pincode_helper') }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            <label class="required" for="address_proof">{{ trans('cruds.helpCenterProfile.fields.address_proof') }}</label>
...
@section('scripts')
    <script>
        $(document).ready(function () {
            ...
            $('#help_center_id').change(function (){
                console.log('here')
                let helpCenterId = $(this).val();
                $.post("{{ route('admin.help-center-profiles.check-profile') }}", {helpCenterId}, result => {
                    if(result.status){
