...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-pincodeAreas">
                <thead>
                    <tr>
                        <th width="10">
                ...
                <tbody>
                    @foreach($areas as $key => $area)
                        <tr data-entry-id="{{ $area->id }}">
                            ...
                            <td>
                                <span style="display:none">{{ $area->status ?? '' }}</span>
...
@endcan
  ...
  let table = $('.datatable-pincodeAreas:not(.ajaxTable)').DataTable({ buttons: dtButtons })
