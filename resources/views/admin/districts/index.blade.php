        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">{{ trans('global.create') }}/{{ trans('global.edit') }} {{ trans('cruds.district.title_singular') }}</h4>
    ...
    <script>
        $(function () {
            ...
            $('#districtForm').submit(function (event){
                ...
                let url = isUpdate ? "{{ route('admin.district.update') }}" : "{{ route("admin.district.add") }}";
            ...
            $('.editButton').click(function (){
                let id = $(this).data('id');
                isUpdate = true;
                $.get("{{ route('admin.get.district') }}", {id}, result => {
                    if(result.status){
                        $('#name').val(result.data.name);
                        $('#id').val(result.data.id);
                        $('#state_id').val(result.data.state_id).trigger('change');
                        $('#addModal').modal('show');
                    }
                }, 'json');
            });
