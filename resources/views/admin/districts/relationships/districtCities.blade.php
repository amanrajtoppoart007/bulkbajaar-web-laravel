...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-districtCities">
                <thead>
                    <tr>
                        <th width="10">
                ...
                <tbody>
                    @foreach($cities as $key => $city)
                        <tr data-entry-id="{{ $city->id }}">
                            ...
                            <td>
                                <span style="display:none">{{ $city->status ?? '' }}</span>
...
@endcan
  ...
  let table = $('.datatable-districtCities:not(.ajaxTable)').DataTable({ buttons: dtButtons })
