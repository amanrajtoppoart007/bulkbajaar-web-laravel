...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-districtBlocks">
                <thead>
                    <tr>
                        <th width="10">
                ...
                <tbody>
                    @foreach($blocks as $key => $block)
                        <tr data-entry-id="{{ $block->id }}">
                            ...
                            <td>
                                <span style="display:none">{{ $block->status ?? '' }}</span>
...
@endcan
  ...
  let table = $('.datatable-districtBlocks:not(.ajaxTable)').DataTable({ buttons: dtButtons })
