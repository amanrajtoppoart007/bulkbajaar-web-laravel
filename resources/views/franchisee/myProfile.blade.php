...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            ...
            <a href="{{ route('franchisee.show.upload.documents.form') }}" class="pull-right">{{ trans('cruds.uploadDocuments.title') }}</a>
        </div>

        <div class="card-body">
            <form method="post" action="{{ route('franchisee.update.profile') }}" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-6">
