                ...
                <ul class="c-header-nav ml-auto">
                    <li class="c-header-nav-item dropdown notifications-menu">
                        <a href="#" class="c-header-nav-link" data-toggle="dropdown">
                            ...
                            @php($alertsCount = \Auth::guard('admin')->user()->adminAlerts()->where('read', false)->count())
                                @if($alertsCount > 0)
                        ...
                        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                            @if(count($alerts = \Auth::guard('admin')->user()->adminAlerts()->withPivot('read')->limit(10)->orderBy('created_at', 'ASC')->get()->reverse()) > 0)
    ...
    $('.searchable-field').select2({
        ...
        language: {
            inputTooShort: function(args) {
                ...
                let translation = '{{ trans('global.search_input_too_short') }}';
