                ...
                <table class=" table table-bordered table-striped table-hover datatable datatable-unitType">
                    ...
                    @foreach($units as $key => $unit)
                        <tr data-entry-id="{{ $unit->id }}">
                            ...
                            <td>
                                <button data-view-url="{{route('vendor.get.unit',['id'=>$unit->id])}}"  class="btn btn-xs btn-info editButton" data-id="{{ $unit->id }}">
                                    {{ trans('global.edit') }}
                                </button>

                                <form action="{{ route('vendor.unit.destroy', $unit->id) }}"
    ...
    <script>
        $(function () {
            ...
            let deleteButton = {
                ...
                url: "{{ route('vendor.unit.massDestroy') }}",
            ...
            $('#unitForm').submit(function (event) {
                ...
                let url = isUpdate ? "{{ route('vendor.unit.update') }}" : "{{ route("vendor.unit.add") }}";
