...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            ...
            <a href="{{ route('vendor.bank-account') }}" class="pull-right">Update Bank Account</a>
            &nbsp;
            <a href="{{ route('vendor.show.upload.documents.form') }}" class="pull-right">{{ trans('cruds.uploadDocuments.title') }}</a>
        </div>
